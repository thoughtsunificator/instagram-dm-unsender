...
The script is expected to run on the page that contain the relevant messages; where you usually type in your messages.

## Prerequisites

1. Install a userscript manager
2. [Install the userscript](#install-the-userscript)
...
1. Go to your messages on instagram.com (usually https://www.instagram.com/direct/inbox/) and select a chat.
2. You should see a menu with a button titled "Unsend all DMs":
![UI Preview](../preview.gif)
3. Click the button and the workflow will start unsending your messages.
